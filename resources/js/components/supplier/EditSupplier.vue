                ...
                <div class="card-body">
                    ...
                    >
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    />
                                    <p class="text-danger" v-if="errors.shop_name">
                                        {{ errors.shop_name[0] }}
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <img :src="form.photo" width="100" height="100" class="img-responsive img-fluid" alt="Employee Photo" />
